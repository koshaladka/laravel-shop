...
class SingUpControllerTest extends TestCase
{
    ...
    {
        $this->request['password_confirmation'] = '123456';
     ...
     * @return void
     */
    public function it_register_event_and_listeners_dispatched(): void
    {
        Event::fake();
     ...
     * @return void
     */
     public function  it_user_created_successfully(): void
     {
